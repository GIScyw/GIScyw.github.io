exports.id = "component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-content-file-path-content-posts-zustand-recipes-index-mdxhead";
exports.ids = ["component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-content-file-path-content-posts-zustand-recipes-index-mdxhead"];
exports.modules = {

/***/ "./content/posts/zustand recipes/index.mdx":
/*!*************************************************!*\
  !*** ./content/posts/zustand recipes/index.mdx ***!
  \*************************************************/
...
function _createMdxContent(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h3, null, "需要注意的点"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "zustand 默认做了变量的优化，只要是从  ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, null, "useStore"), "解构获得的函数，默认是引用不变的，也就是使用 zustand store 的函数本身并不会造成不必要的重复渲染。所有 zustand 的 action 都默认不会造成重复渲染，因此，理论上只有 state 会造成重复渲染"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "在这种模式下，所有的 Action 都是默认不需要包 useCallback 的"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "因为 zustand 是默认全局单例，所以如果需要变成组件，那么一定需要使用 Context 来隔离多个实例"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "只需要利用 zustand 的 useStore 的 selector 能力，配合 zustand 默认提供的  ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, null, "shallow"), "  浅比较能力。我们就能实现「人工的依赖收集」。如此一来，性能优化也就做好了"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "zustand 默认不需要 provider，由于没有 Provider 的存在，所以声明的 useStore 默认都是单实例，如果需要多实例的话，zustand 也提供了对应的 Provider 的书写方式"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "zustand 的 store 状态既可以在 react 世界中消费，也可以在 react 世界外消费。实际的复杂应用中，一定会存在某些不在 react 环境内的状态数据，以图表、画布、3D 场景最多。一旦要涉及到多环境下的状态管理，zustand 很有用处。、"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, null, "zustand"), "  基于发布订阅模式实现的响应式"), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h3, null, "业务中比较好的实践"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "业务中的两种形式：hook+zustand， 其中 zustand  维护基本的 state 和原子 action，hook 维护复合 action; 全部 zustand"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "复杂应用的建议：合理拆分 state, action,selectors; 利用 slice 切片"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "action 的定义可以根据用户的行为"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "zustand 在项目中的应用，可以给我们的开发模式发生变化。基于这样的一种模式，哪怕是这样一个复杂的组件，在实现层面的研发心智仍然非常简单：", "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "React 层面仍然只是一个渲染层；"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "复杂的状态逻辑仍然以 hooks 式的模式进行引入；"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "复杂的入口方法通过拆分子 Action 进行组合与复用；"), "\n"), "\n"), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h3, null, "高级用法："), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "集成一下 devtools，将 Store 研发模式变得更加可视化，做到可控"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "结合 persist 做本地数据缓存的方式"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "利用 subscribe 监听状态变更，自动更新内部状态"), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h3, null, "官网建议"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "set 是将与 Store 中的现有状态进行浅合并， 对于嵌套更新，层级较少的嵌套直接使用...， 层级较多的嵌套可以使用 immer 更新嵌套状态"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "自动生成 selector"), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.pre, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, {
    className: "language-js"
  }, "const bears = useBearStore((state) => state.bears);\n\nconst useBearStore = createSelectors(useBearStoreBase);\n// get the property\nconst bears = useBearStore.use.bears();\n")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "建议在使用 store 的属性或操作时使用 selector"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "选择你需要的 state 和 action"), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.pre, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, {
    className: "language-js"
  }, "const [firstName, updateFirstName] = useStore(\n  (state) => [state.firstName, state.updateFirstName],\n\n  shallow\n);\n")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "action 和状态一般是放在一起的，但是也推荐将 action 放到 store 外面，有利于代码拆分"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "使用 storage 来持久化状态与 action"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "重置所有状态"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "在需要依赖注入的情况下，比如一个 store 需要用来自组件的 props 进行初始化，建议使用带有  ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.code, null, "React.context"), "  的原始 store。"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "slice 模式， 把 store 分成更小的 store"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "在组件外面使用，通过 subscribeWithSelector 中间件，", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://docs.pmnd.rs/zustand/recipes/recipes#reading/writing-state-and-reacting-to-changes-outside-of-components"
  }, "https://docs.pmnd.rs/zustand/recipes/recipes#reading/writing-state-and-reacting-to-changes-outside-of-components")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "在非 react 地方使用， ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://docs.pmnd.rs/zustand/recipes/recipes#using-zustand-without-react"
  }, "https://docs.pmnd.rs/zustand/recipes/recipes#using-zustand-without-react")), "\n"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "参考资料："), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://juejin.cn/post/7177216308843380797?searchId=202312021508198CC91A1B05709C0BBEE6"
  }, "谈谈复杂应用的状态管理（上）：为什么是 Zustand - 掘金"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://juejin.cn/post/7182462103297458236#heading-3"
  }, "谈谈复杂应用的状态管理（下）：基于 Zustand 的渐进式状态管理实践 - 掘金"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://juejin.cn/post/7056568996157456398?searchId=202312021508198CC91A1B05709C0BBEE6"
  }, "精读《zustand 源码》 - 掘金")), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://zustand-cn.js.org/guides/updating-state"
  }, "https://zustand-cn.js.org/guides/updating-state"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://codthing.github.io/react/zustand/zustand-base/"
  }, "https://codthing.github.io/react/zustand/zustand-base/"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.a, {
    href: "https://docs.pmnd.rs/zustand/recipes/recipes"
...
/***/ "./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx?__contentFilePath=/Users/chenyawei/blog/GIScyw.github.io/content/posts/zustand recipes/index.mdx&export=head":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx?__contentFilePath=/Users/chenyawei/blog/GIScyw.github.io/content/posts/zustand recipes/index.mdx&export=head ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Users_chenyawei_blog_GIScyw_github_io_content_posts_zustand_recipes_index_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./content/posts/zustand recipes/index.mdx */ "./content/posts/zustand recipes/index.mdx");
...
function GatsbyMDXWrapper(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_post__WEBPACK_IMPORTED_MODULE_2__["default"], props, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Users_chenyawei_blog_GIScyw_github_io_content_posts_zustand_recipes_index_mdx__WEBPACK_IMPORTED_MODULE_1__["default"], props));
}
...
;
//# sourceMappingURL=component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-content-file-path-content-posts-zustand-recipes-index-mdxhead.js.map